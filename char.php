...
{
  $favname=$_POST['test1'];
$sql = "UPDATE mysystem SET fav='$favname' WHERE username='$name'";
...
$sql = "SELECT id, composer, genre FROM track WHERE composer='$lname'";
...
<body>
                ...
                <div class="container-fluid">
                    ...
                    <nav class="classy-navbar justify-content-between" id="musicaNav">
                        ...
                        <div class="classy-menu">
                            ...
                            <button style=" width:50px; background-color:  #bd177a; float: right;  border: none; padding: 5px 5px; text-align: center; text-decoration: none;  display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer; font-family: sans-serif; font-weight: bold; border-radius: 4px;"  type="submit" onclick="myFunction()" name="Submit11">Go!</button>
                            <p id="demo"></p>
</form>
                                    <a href="ac.php"><i  aria-hidden="true" style="color:white;"><?php echo $name; ?></i></a>
                                </div>
    ...
    <div class="featured-album-area section-padding-100 clearfix" id="ttrack">
                            ...
                            <div class="album-all-songs">
                                ...
                                <div class="music-playlist">
                                    ...
                                    <div class="single-music active">
                                        ...
                                        <button style="background-color:  #bd177a;   border: none; padding: 5px 5px; text-align: center; text-decoration: none;  display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer; font-family: sans-serif; font-weight: bold; border-radius: 4px;" onclick="cs_change_music('audio/dummy-audio.mp3');my('Drop that Beat')" id="preview">Drop that Beat</button>
                                        
                                        <button style="background-color:  #bd177a; float: right;  border: none; padding: 5px 5px; text-align: center; text-decoration: none;  display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer; font-family: sans-serif; font-weight: bold; border-radius: 4px;"type="button" value="jhon" class="shift" onclick="pushRules1('Drop the Beat')" name="john">Add to playlist</button>
                                    </div>

                                    <!-- Single Song -->
                                    <div class="single-music">
                                    <button style="background-color:  #bd177a;   border: none; padding: 5px 5px; text-align: center; text-decoration: none;  display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer; font-family: sans-serif; font-weight: bold; border-radius: 4px;"onclick="cs_change_music('audio/sofi.mp3'); my('Hey,Mister Dj')" id="preview" value="messa">Hey,mister Dj</button>
                        
                                        <button  style="background-color:  #bd177a; float: right;  border: none; padding: 5px 5px; text-align: center; text-decoration: none;  display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer; font-family: sans-serif; font-weight: bold; border-radius: 4px;" type="button" value="jhon" class="shift" onclick="pushRules1('Hey,Mister Dj')">Add to playlist</button>
                                    </div>
                                    ...
                                    <button style="background-color:  #bd177a;   border: none; padding: 5px 5px; text-align: center; text-decoration: none;  display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer; font-family: sans-serif; font-weight: bold; border-radius: 4px;"onclick="cs_change_music('audio/dummy-audio.mp3');my('Drop the Beat')" id="preview">Hey,mister Dj</button>
                                        ...
                                        <button style="background-color:  #bd177a; float: right;  border: none; padding: 5px 5px; text-align: center; text-decoration: none;  display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer; font-family: sans-serif; font-weight: bold; border-radius: 4px;" type="button" value="jhon" class="shift" onclick="pushRules1('eyelash')">Add to playlist</button>
                                    </div>
                                    ...
                                    <!-- Single Song -->
                                    <div class="single-music">
                                    <button style="background-color:  #bd177a;   border: none; padding: 5px 5px; text-align: center; text-decoration: none;  display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer; font-family: sans-serif; font-weight: bold; border-radius: 4px; margin-left: 260px;" onclick="cs_change_music('audio/dummy-audio.mp3');my('Drop the Beat')" id="preview">Hey,mister Dj</button>
                                    <button style="background-color:  #bd177a; float: right;  border: none; padding: 5px 5px; text-align: center; text-decoration: none;  display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer; font-family: sans-serif; font-weight: bold; border-radius: 4px;" type="button" value="jhon" class="shift" onclick="pushRules1('eyelash')">Add to playlist</button>
                                    </div>
                                   <!-- Single Song -->
                                    <div class="single-music">
                                    <button style="background-color:  #bd177a;   border: none; padding: 10px 5px; text-align: center; text-decoration: none;  display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer; font-family: sans-serif; font-weight: bold; border-radius: 4px; " onclick="cs_change_music('audio/dummy-audio.mp3');my('Drop the Beat')" id="preview">Hey,mister Dj</button>
                                    <button style="background-color:  #bd177a; float: right;  border: none; padding: 10px 15px; text-align: center; text-decoration: none;  display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer; font-family: sans-serif; font-weight: bold; border-radius: 4px;" type="button" value="jhon" class="shift" onclick="pushRules1('eyelash')">Add to playlist</button>
                                    </div>
                                    <!-- Single Song -->
                                    <div class="single-music">
                                    <button style="background-color:  #bd177a;   border: none; padding: 10px 5px; text-align: center; text-decoration: none;  display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer; font-family: sans-serif; font-weight: bold; border-radius: 4px; margin-left: 260px;" onclick="cs_change_music('audio/dummy-audio.mp3');my('Drop the Beat')" id="preview">Hey,mister Dj</button>
        ...
        <h4 style="color: violet;">CHECK YOUR PLAYLIST</h4>
      <h5>  <ul id="list" style="color:white"></ul></h5>
                            <!-- Now Playing -->
                            ...
                            <div class="album-songs h-100">
                                ...
                                <div class="album-info mb-50 d-flex flex-wrap align-items-center justify-content-between">
                                    <div class="album-title">
                                        <h6>Top artist</h6>
                                        <form method=post>
                                        <h4>Taylor Swift</h4><button style="background-color:  #bd177a;   border: none; padding: 10px 15px; text-align: center; text-decoration: none;  display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer; font-family: sans-serif; font-weight: bold; border-radius: 4px;" type=submit name="test1" class="like1" value="Taylor Swift" onclick="myFunction()" >Favourite</button></form>
                                    </div>
                                    <div class="album-buy-now">
                                ...
                                <div class="artist-charts" >
                                    ...
                                    <h5 style="padding-top: -2px; ">Billie Eilish <button style="background-color:  #bd177a;   border: none; padding: 10px 5px; text-align: center; text-decoration: none;  display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer; font-family: sans-serif; font-weight: bold; border-radius: 4px ; margin-left: 280px;"type=submit name="test1" class="like1" value="Bellie Eillish" onclick="myFunction()" >Favourite</button></h5></div>
                                ...
                                <form method=post> 
                                <div class="artist-charts">
                                    <h5>Justin Bieber <button style="background-color:  #bd177a;   border: none; padding: 10px 5px; text-align: center; text-decoration: none;  display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer; font-family: sans-serif; font-weight: bold; border-radius: 4px; margin-left: 260px;"type=submit name="test1" class="like1" value="Ariana Grande" onclick="myFunction()" >Favourite</button></h5></div>
                                
                                </form>
                                <form method=post>
                                <div class="artist-charts">
                                    <h5>DJ Khaled <button style="background-color:  #bd177a;   border: none; padding: 10px 5px; text-align: center; text-decoration: none;  display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer; font-family: sans-serif; font-weight: bold; border-radius: 4px; margin-left: 290px;"type=submit name="test1" class="like1" value="DJ Khaled" onclick="myFunction()" >Favourite</button></h5></div> 
                                </form>
                                
                                <form method=post>
                                <div class="artist-charts">
                                    <h5>Lady Gaga <button style="background-color:  #bd177a;   border: none; padding: 10px 5px; text-align: center; text-decoration: none;  display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer; font-family: sans-serif; font-weight: bold; border-radius: 4px; margin-left: 285px;"type=submit name="test1" class="like1" value="Ariana Grande" onclick="myFunction()" >Favourite</button></h5></div>
                                </form>
