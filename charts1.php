                        ...
                        <div class="album-songs h-100">
                            ...
                            <div class="album-all-songs">
                                ...
                                <div class="music-playlist">
                                    ...
                                    <button style="width: 490px; background-color:  #bd177a;   border: none; padding: 8px 8px; text-align: center; text-decoration: none;  display: inline-block; font-size: 20px; margin: 4px 10px; cursor: pointer; font-family: sans-serif; font-weight: bold; border-radius: 4px;" onclick="cs_change_music('audio/dummy-audio.mp3');my('Drop the Beat')" id="preview">Hey,mister Dj</button>
                                    ...
                                    <button style="width: 490px; background-color: lightpink;   border: none; padding: 8px 8px; text-align: center; text-decoration: none;  display: inline-block; font-size: 20px; margin: 4px 10px; cursor: pointer; font-family: sans-serif; font-weight: bold; border-radius: 4px;"onclick="cs_change_music('audio/sofi.mp3'); my('Message to the Future')" id="preview" value="messa">Message to my fuure self</button>
